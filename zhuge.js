window._zhugeSdk = function(e) {
    ...
    var i, n, r, o, a, s, c, u, d, p, l, h = window.navigator, f = window.document, g = h.userAgent, v = Array.prototype, m = Object.prototype, _ = m.toString, y = v.forEach, w = Array.isArray, k = v.slice, b = m.hasOwnProperty, S = {}, T = [], z = null, A = {
        each: function(e, t, i) {
            if (null != e)
                if (y && e.forEach === y)
                    e.forEach(t, i);
